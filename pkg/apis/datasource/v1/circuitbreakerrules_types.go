...
type CircuitBreakerRule struct {
	...
	MaxSlowRequestRatio float64 `json:"maxSlowRequestRatio"`
	ErrorRatioThreshold float64 `json:"errorRatioThreshold"`
	ErrorCountThreshold uint64  `json:"errorCountThreshold"`
}
...
// +kubebuilder:resource:path=circuitbreakerrules,scope=Namespaced
