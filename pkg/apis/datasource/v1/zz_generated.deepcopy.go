...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SpecificItem) DeepCopyInto(out *SpecificItem) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SpecificItem.
func (in *SpecificItem) DeepCopy() *SpecificItem {
	if in == nil {
		return nil
	}
	out := new(SpecificItem)
	in.DeepCopyInto(out)
	return out
}
